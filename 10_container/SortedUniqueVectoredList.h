 ...
 *        Kontener ten w razie braku miejsca tworzy nowy @Bucket i tam dodaje nowy element.
 *
 * @note Zmiany pliku naglowkowego nie powinny byc konieczne, prosze probowac zmienic jedynie w pliku zrodlowym SortedUniqueVectoredList.cpp.
 *
 ...
 * @param head wskaznik na pierwszy @ref Bucket
 * @param tail wskaznik na pierwszy @ref Bucket **/
