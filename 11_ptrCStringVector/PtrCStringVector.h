 ...
 *
 * @note Proszę nie modyfikować pliku nagłówkowego, jedynie źródłowy @ref PtrCStringVector.cpp.
 *       Metody pomocnicze, ktore mozna (ale nie trzeba) wykorzystac juz sa zadeklarowane.
 *       Niezadeklarowane metody można zaimplementować jako funkcje w pliku źródłowym.
 *
