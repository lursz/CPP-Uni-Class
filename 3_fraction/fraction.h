...
public:
   Fraction(int licznik = 0, int mianownik = 1, std::string nazwa_otrzymana = "kompilator_inaczej_dawal_blad");
   //Fraction();
   ~Fraction();

   int getNumerator() const;
   void setNumerator(int temp_numerator);
   int getDenominator() const;
   void setDenominator(int temp_denominator);
