...
- skladowa statyczna: `tsd::size_t instances_` liczaca aktualnie zyjace instancje
...
{
protected:
   static int instances_; // Aktualnie zyjace instancje
   char *data_;           // Wskaznik na zaalokowany obszar z tekstem
   int size_;             // Mowi ile znakow ma aktualny tekst
   int capacity_;         // Ile znakow pomiesci buffor bez realokacji
...
public:
   ...
   bool equal_to(SimpleString nowy, bool case_sensitive = true) const;
   void append(SimpleString value_to_add);
};
